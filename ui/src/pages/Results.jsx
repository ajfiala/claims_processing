  ...
  return (
    <div className="my-4 text-center">
      <img
        ...
        onError={handleError}
        className={`max-w-full rounded-md border shadow-md max-h-64 mx-auto transition-opacity duration-300 ${
        ...
        {isThinking ? (
          <motion.div key="thinking" {...animate} className="absolute w-full">
            <div className="flex justify-center">
              <div>
                <h1 className="text-3xl text-center text-gray-800 dark:text-gray-100">Validating form ...</h1>
              </div>
            </div>
