                        ...
                        <div className="flex justify-center px-2">
                            <div>
                                ...
                                <p className="text-muted-foreground mt-2 text-center">
                                    {isSuccess ? "We were able to determine the following issues with your vehicle." : "Please check the issues and upload another form."}
                                </p>
                            </div>
                        </div>
                            ...
                            <div className="flex flex-col items-center">
                                {!isSuccess ? (
                                    ...
                                    <>
                                        ...
                                        <div className="sm:px-6 py-12 rounded-md sm:shadow-2xl max-w-3xl w-full my-6 sm:border-[rgba(236,236,236,0.43)] ">
